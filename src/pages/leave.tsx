...
const LeavePage: React.FC = () => {
  ...
  return (
    <Page className="bg-gray-50/50">
      ...
      <Box className="px-4 py-4 space-y-6">
        <Tabs
          activeKey={activeTab}
        ...
        >
          ...
          <Box className="flex-1 overflow-y-auto p-8 space-y-8 pb-32">
            <div className="space-y-4">
              ...
              <ZSelect
                placeholder="Chọn loại hình nghỉ phép"
                closeOnSelect
                className="grow w-full h-14 bg-white dark:bg-[#262A31] border-gray-100 dark:border-[#353A45] rounded-2xl px-2 font-bold text-slate-700 dark:text-slate-200 shadow-sm transition-all focus:ring-2 focus:ring-orange-500/20"
              >
                <Option value="annual" title="Nghỉ phép năm" />
                <Option value="sick" title="Nghỉ ốm (BHXH)" />
                <Option value="casual" title="Việc riêng" />
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2.5">
                  ...
                  <input
                    type="date"
                    className="flex h-14 w-full rounded-2xl border border-gray-100 dark:border-[#353A45] bg-white dark:bg-[#262A31] px-6 py-2 text-sm font-bold shadow-sm transition-all focus:ring-2 focus:ring-orange-500/20 outline-none text-slate-900 dark:text-white"
                  />
                </div>
                <div className="space-y-2.5">
                  <span className="text-[10px] font-black text-slate-400 ml-2 uppercase tracking-widest">
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                className="w-full min-h-32 bg-white dark:bg-[#262A31] border border-gray-100 dark:border-[#353A45] rounded-[2rem] p-6 font-medium resize-none shadow-sm focus:ring-2 focus:ring-orange-500/20 outline-none"
              />
            </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-black text-emerald-700 dark:text-emerald-400">
                    Số dư sau khi nghỉ: <span className="text-lg">13 ngày</span>
                  </p>
                </div>
              </div>
              <Badge
            ...
            <div className="flex flex-row gap-4 mt-8 pb-10">
              ...
              <ZButton className="flex-[2.5] h-14 rounded-2xl font-black gap-3 shadow-2xl shadow-orange-500/30 bg-orange-500 text-white border-none uppercase tracking-widest text-xs">
